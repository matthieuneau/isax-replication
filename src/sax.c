...
SaxPairPair promoteCardinality(SaxPair symbol1, SaxPair symbol2)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                while
                    symbol1.cardinality < symbol2.cardinality
                    {
    ...
    double saxDistance(SaxPair symbol1, SaxPair symbol2)
    {
        ...
        else
        {
            if (symbol1 < symbol2)
            {
                return saxBreakpoint[symbol1][cardinality - 1] - saxBreakpoint[symbol2 - 1][cardinality - 1];
            }
            else
            {
                return saxBreakpoint[symbol2][cardinality - 1] - saxBreakpoint[symbol1 - 1][cardinality - 1];
            }
        }
    }
